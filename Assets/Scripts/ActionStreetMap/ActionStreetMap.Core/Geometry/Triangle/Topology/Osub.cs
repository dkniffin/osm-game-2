...
{
    /// <summary> An oriented subsegment. </summary>
    /// <remarks>
    ...
    internal struct Osub
    {
        ...
        /// <summary> Reverse the orientation of a subsegment. [sym(ab) -> ba]. </summary>
        ...
        /// <summary> Find adjoining subsegment with the same origin. [pivot(ab) -> a*] </summary>
        /// <remarks>
        ...
        /// <summary> Find next subsegment in sequence. [next(ab) -> b*] </summary>
        ...
        /// <summary> Get the origin of a subsegment. </summary>
        public Vertex Org()
        {
            return seg.vertices[orient];
        }

        /// <summary> Get the destination of a subsegment. </summary>
        public Vertex Dest()
        {
        ...
        /// <summary> Set the origin or destination of a subsegment. </summary>
        internal void SetOrg(Vertex vertex)
        {
            seg.vertices[orient] = vertex;
        }

        /// <summary> Set destination of a subsegment. </summary>
        internal void SetDest(Vertex vertex)
        {
            seg.vertices[1 - orient] = vertex;
        }

        /// <summary> Get the origin of the segment that includes the subsegment. </summary>
        internal Vertex SegOrg()
        {
            return seg.vertices[2 + orient];
        }

        /// <summary> Get the destination of the segment that includes the subsegment. </summary>
        internal Vertex SegDest()
        {
            return seg.vertices[3 - orient];
        }

        /// <summary> Set the origin of the segment that includes the subsegment. </summary>
        internal void SetSegOrg(Vertex vertex)
        {
            seg.vertices[2 + orient] = vertex;
        }

        /// <summary> Set the destination of the segment that includes the subsegment. </summary>
        internal void SetSegDest(Vertex vertex)
        {
            seg.vertices[3 - orient] = vertex;
        }

        /// <summary> Bond two subsegments together. [bond(abc, ba)] </summary>
        ...
        /// <summary> Dissolve a subsegment bond (from one side). </summary>
        /// <remarks>
        ...
        /// <summary> Test for equality of subsegments. </summary>
        internal bool Equal(Osub os)
        {
            return ((seg == os.seg) && (orient == os.orient));
        }

        /// <summary> Dissolve a bond (from the subsegment side). </summary>
        internal void TriDissolve(Triangle dummy)
        {
            seg.triangles[orient].tri = dummy;
        }

        /// <summary> Check a subsegment's deallocation. </summary>
        internal static bool IsDead(Segment sub)
        {
            return sub.subsegs[0].seg == null;
        }

        /// <summary> Set a subsegment's deallocation. </summary>
